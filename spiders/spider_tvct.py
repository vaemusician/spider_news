...
# Y TVBS新闻网
class TvctSpider(Spider):
    def __init__(self, req_params):
        super().__init__(req_params)
        self.source = 'www.tvbs.com.tw'
        self.source_url = 'https://news.tvbs.com.tw'
    ...
    def get_news_last_list(self):
        ...
        head[
            'User-Agent'] = self.ua
        wb_url = 'https://news.tvbs.com.tw/hot'
    ...
    def analyze_news_last_list(self, news_last_list_text):
        ...
        trs = text_tree.xpath('//*[@id="block_pc"]/li')
        for tr in trs:
            detail = dict()
...
# }
# spid = TvctSpider(req_params=req)
# spid.crawling_news()
