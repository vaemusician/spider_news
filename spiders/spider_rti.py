...
# Y  中央广播电台(RTI)
class RtiSpider(Spider):
    def __init__(self, req_params):
        super().__init__(req_params)
        self.source = 'https://www.rti.org.tw/'
        self.source_url = 'https://www.rti.org.tw/'
    ...
    def get_news_last_list(self, ):
        ...
        head[
            'User-Agent'] = self.ua
        wb_url = 'https://www.rti.org.tw/news'
    ...
    def analyze_news_last_list(self, news_last_list_text):
        ...
        trs_hot = text_tree.xpath('//*[@id="RTIall"]/div[2]/div[1]/section[2]/ul/li')
        for tr_hot in trs_hot:
            detail = dict()
            href_url = ''.join(tr_hot.xpath('div[3]/a/@href') or '')
            if href_url == '':
                continue
            if 'http' in href_url:
                detail['url'] = href_url
        ...
        trs = text_tree.xpath('//*[@id="RTIall"]/div[2]/div[2]/section[2]/ul/li')  # hot
        for tr in trs:
            detail = dict()
