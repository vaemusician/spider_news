...
# Y  东升电视台
class NentSpider(Spider):
    def __init__(self, req_params):
        super().__init__(req_params)
        self.source = 'news.ebc.net.tw'
        self.source_url = 'https://news.ebc.net.tw'
    ...
    def get_news_last_list(self):
        ...
        head[
            'User-Agent'] = self.ua
        wb_url = 'https://news.ebc.net.tw/realtime'
    ...
    def analyze_news_last_list(self, news_last_list_text):
        ...
        trs = text_tree.xpath('//div[@class="style1 white-box"]')
        for tr in trs:
            detail = dict()
...
# }
# spid = NentSpider(req_params=req)
# spid.crawling_news()
