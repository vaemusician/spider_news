...
# Y  汉声广播电台
class VctSpider(Spider):
    def __init__(self, req_params):
        super().__init__(req_params)
        self.source = 'www.voh.com.tw'
        self.source_url = 'https://www.voh.com.tw/tw/News/'
    ...
    def get_news_last_list(self):
        ...
        head[
            'User-Agent'] = self.ua
        wb_url = 'https://www.voh.com.tw/tw/News/ugC_News.aspx'  # 每页20按时间排序
    ...
    def analyze_news_last_list(self, news_last_list_text):
        ...
        trs = text_tree.xpath(
            '//*[@id="ContentPlaceHolder1_TableList_ul_0"]/li')  # ContentPlaceHolder1_TableList_ul_1每页20条
        for tr in trs:
            detail = dict()
